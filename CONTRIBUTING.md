...
```bash
git clone git@github.com:term-app/stage.git
cd stage
pnpm install
```
...
You can use the playground at [`playgrounds/basic`](./playgrounds/basic/) to experiment with your changes to STAGE™ locally.
...
```jsonc
{
  ...
  "pnpm": {
    "overrides": {
      "@term-app/stage": "link:../path/to/term-app/packages/stage",
      // additionally/optional the adapter you're using
      "@term-app/adapter-auto": "link:../path/to/term-app/packages/adapter-auto"
    }
  }
}
``
...
// TODO: THIS IS SOURCED FROM THE SVELTEKIT REPO. IT NEEDS TO BE UPDATED TO STAGE.
